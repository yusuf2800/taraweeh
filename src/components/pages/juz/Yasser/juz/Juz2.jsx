...
const Juz2Y = ({ name }) => {
  ...
  audios.push({
    id: 2,
    name: `Juz 2`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz2Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(2)}/{String(2)}.pdf`,
  });
