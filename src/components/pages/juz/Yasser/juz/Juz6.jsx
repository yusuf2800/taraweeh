...
const Juz6Y = ({ name }) => {
  ...
  audios.push({
    id: 6,
    name: `Juz 6`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz6Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(6)}/{String(6)}.pdf`,
  });
