...
const Juz3Y = ({ name }) => {
  ...
  audios.push({
    id: 3,
    name: `Juz 3`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz3Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(3)}/{String(3)}.pdf`,
  });
