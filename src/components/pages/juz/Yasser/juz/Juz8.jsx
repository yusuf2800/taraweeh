...
const Juz8Y = ({ name }) => {
  ...
  audios.push({
    id: 8,
    name: `Juz 8`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz8Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(8)}/{String(8)}.pdf`,
  });
