...
const Juz5Y = ({ name }) => {
  ...
  audios.push({
    id: 5,
    name: `Juz 5`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz5Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(5)}/{String(5)}.pdf`,
  });
