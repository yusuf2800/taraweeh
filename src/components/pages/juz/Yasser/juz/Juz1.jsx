...
const Juz1Y = ({ name }) => {
  ...
  audios.push({
    id: 1,
    name: `Juz 1`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz1Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(1)}/{String(1)}.pdf`,
  });
