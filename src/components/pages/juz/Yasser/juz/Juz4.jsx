...
const Juz4Y = ({ name }) => {
  ...
  audios.push({
    id: 4,
    name: `Juz 4`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz4Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(4)}/{String(4)}.pdf`,
  });
