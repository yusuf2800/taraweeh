...
const Juz9Y = ({ name }) => {
  ...
  audios.push({
    id: 9,
    name: `Juz 9`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz9Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(9)}/{String(9)}.pdf`,
  });
