...
const Juz7Y = ({ name }) => {
  ...
  audios.push({
    id: 7,
    name: `Juz 7`,
    audio_path: `https://res.cloudinary.com/ddsiorkrx/video/upload/v1740422996/juz7Y.mp3`,
    file_path: `/quran pdfs/juz{Math.floor(7)}/{String(7)}.pdf`,
  });
